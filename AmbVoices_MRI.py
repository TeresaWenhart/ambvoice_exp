...
#os.makedirs("data/" + expInfo['condition']+'_' + expInfo[u'participant'] + "/") uncomment, if you do not run baseline experiment before: directory/participants' folder has to be created
...
while end:
    ...
    if trial_num >= 0:
        ...
        while trial_finished == 0:
            ...
            keys = kb.getKeys(['y','b','escape'], clear=True)
